  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/Dashstation" class="brand-link">
      <img src="{{asset('img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Dashboard-Station</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview @if(request()->is('home'))  menu-open @endif ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/home" class="nav-link <? php if(request()->is('\home')) { active } ?> ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Home-Slider</p>
                </a>
              </li>
              <li class="nav-item active">
                <a href="dashboard/teacher" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Teacher</p>
                </a>
              </li>
